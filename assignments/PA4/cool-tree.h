...
public:
   ...
   virtual bool check_inheritance_circle() = 0; // true if there is a circle, false if not 
   virtual void pre_check() = 0; // check the if circle, invalid redefine, invalid inherit, Main exists
